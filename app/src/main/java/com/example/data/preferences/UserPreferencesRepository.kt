...
class UserPreferencesRepository(private val context: Context) {
    ...
    val customerCategoryFlow: Flow<com.example.domain.model.CustomerCategory> = context.dataStore.data
        .map { prefs ->
            val raw = prefs[KEY_CUSTOMER_CATEGORY]
            com.example.domain.model.CustomerCategory.fromId(raw)
        }
        .distinctUntilChanged()
    ...
    suspend fun setCustomerCategory(category: com.example.domain.model.CustomerCategory) {
        context.dataStore.edit { prefs ->
