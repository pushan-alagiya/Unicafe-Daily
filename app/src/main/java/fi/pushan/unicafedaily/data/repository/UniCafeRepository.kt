package fi.pushan.unicafedaily.data.repository
...
import fi.pushan.unicafedaily.data.preferences.UserPreferencesRepository
...
class UniCafeRepository(
    ...
    suspend fun setMyDietPreference(diet: fi.pushan.unicafedaily.domain.model.MyDietPreference) {
    ...
    suspend fun setCampusPreference(campus: fi.pushan.unicafedaily.domain.model.Campus) {
    ...
    suspend fun recordRecentlyViewed(dish: fi.pushan.unicafedaily.domain.model.RecentlyViewedDish) {
